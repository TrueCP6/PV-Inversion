...
To calculate the source term $q(x,y,z)$ we must first specify the background state $\overline{Q}$. We will derive this from the full formulation of EPV \eqref{epv} and the Brunt–Väisälä frequency \eqref{brunt_vaisala}. %TODO reference \zeta_g
...
\begin{equation}\label{full_q} %TODO plots of q and Q
